...
public class StreamEx01 {
  ...
  public static void main(String[] args) {
    ...
    //boxed 메서드를 사용하여 IntStream 을 Stream<Integer>
    List<Integer> list1 = IntStream.rangeClosed(1,10).filter(number ->number %2 ==1).boxed().toList();
    list1.forEach(System.out::println);

    //소문자  영문 과일 이름을 대문자로 과일명으로 변경하기
